...
type CurrencyClient interface {
	GetRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *currencyClient) GetRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type CurrencyServer interface {
	GetRate(context.Context, *RateRequest) (*Response, error)
...
func (UnimplementedCurrencyServer) GetRate(context.Context, *RateRequest) (*Response, error) {
